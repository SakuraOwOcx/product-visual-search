...
def main():
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        try:
            train_metrics = run_epoch(model, train_loader, criterion, device, optimizer, scaler, args.max_train_batches)
            val_metrics = run_epoch(model, val_loader, criterion, device, None, None, args.max_val_batches)
